...
Welcome to my Software Quality Assurance (SQA) repository! This space showcases my practical, hands-on work in manual software testing, test case design, defect logging, and API testing.
...
### 3. [ReqRes API Testing (Postman Collection)](./API%20Testing.postman_collection.json)
*   **Description:** A complete manual API testing suite for verifying CRUD (Create, Read, Update, Delete) operations using Postman and the [ReqRes API](https://reqres.in/).
*   **Skills Demonstrated:** Custom header configuration (`x-api-key`), JSON payload structuring, and HTTP response status code verification.

---

## 📌 API Project Deep Dive (Postman Collection)

The objective of this project was to verify the behavior, structure, and reliability of core API endpoints. 
